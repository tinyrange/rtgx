...
// rtg:linkstatic /usr/lib/libobjc.A.dylib,objc_lookUpClass
func objcLookUpClass(name string) int { return 0 }

// rtg:linkstatic /usr/lib/libobjc.A.dylib,objc_getMetaClass
func objcGetMetaClass(name string) int { return 0 }

// rtg:linkstatic /usr/lib/libobjc.A.dylib,class_getName
func classGetName(class int) int { return 0 }

// rtg:linkstatic /usr/lib/libobjc.A.dylib,object_getClass
