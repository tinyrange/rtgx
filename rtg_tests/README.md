...
- `regressions/` contains 10 hand-maintained cases that are never replaced by the generator.
- `negative/` contains 10 checked rejection cases with exact phase, code, source location, and message expectations.
