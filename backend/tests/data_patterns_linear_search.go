...
func appMain(args []string) int {
	...
	table = append(table, symbolRecord{name: "red", value: 7})
	table = append(table, symbolRecord{name: "blue", value: 9})
	if findSymbol(table, "blue") != 1 {
		print("RENVO-0877 linear search failed\n")
		return 1
	}
	print("PASS\n")
	return 0
