...
func appMain(args []string) int {
	globalRecords = append(globalRecords, symbolRecord{name: "slot", value: 1})
	i := findSymbol(globalRecords, "slot")
	globalRecords[i].value = 8
	if globalRecords[0].value != 8 {
		print("RENVO-0878 update field failed\n")
		return 1
	}
	print("PASS\n")
	return 0
